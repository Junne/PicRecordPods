...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is PRHomeModule
                   DESC

  s.homepage     = "https://github.com/Junne/PRHomeModule"
  ...
  s.source       = { :git => "https://github.com/Junne/PRHomeModule.git", :tag => s.version.to_s }
  ...
  s.source_files  = "PRHomeModule/PRHomeModule/**/*.{h,m}"
